...
export const Section = function Section({ children, id, name }: SectionProps) {
  return (
    <div className="flex flex-col gap-2 my-20 text-center items-center justify-center relative w-full">
